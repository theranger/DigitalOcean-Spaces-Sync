...
<div class="dos__page row">
	...
	<div class="col-xs-12 col-sm-12 col-md-8 col-lg-8">
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<h2>DigitalOcean Spaces
					Sync <?php _e('Settings', 'dos'); ?></h2>
			</div>
		...
		<form method="POST" action="options.php">
			...
			<div class="dos__block">
				...
				<div class="row larger">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
						<input id="upload_url_path" name="upload_url_path"
							   type="text" class="regular-text code"
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
						...
						<div class="dos__description">
							<?php _e('Local path to the uploaded files. By default', 'dos'); ?>
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-10">
						...
						<div class="dos__description">
							<?php _e('By default empty or', 'dos'); ?>
							<code>*</code>
			...
			<div class="row">
				...
				<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1"
					 style="width: 50px;">
					<input id="onlystorage" type="checkbox"
						   name="dos_storage_file_only"
			...
			<div class="row">
				...
				<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
					<input id="dos_storage_file_delete" type="checkbox"
						   name="dos_storage_file_delete"
	...
	<div class="col-xs-12 col-xs-12 col-md-4 col-lg-4">
		...
		<p>
			<img id="img-spinner"
				 src="<?php echo plugins_url() . '/' . dirname(plugin_basename(__FILE__)); ?>/assets/images/do_logo.svg"
				 alt="DigitalOcean"
				 style="width: 150px;"/>
		</p>

		<p>
			This plugin syncs your WordPress library with DigitalOcean Spaces
			Container. It may be buggy, it may sometimes fail, feel free to
			write issues on github and PR.
		</p>

		<p>
			<a href="https://github.com/keeross/DigitalOcean-Spaces-Sync/"
